...
const StockRow = () => {
    ...
    const getMyStocks = () => {
        db.collection('users/V15HmhTXvZMSRGwWsrPWGsBv8zs1/stocks').onSnapshot(
            (snapshot) => {
                let promises = []
                let tempData = []
                            ...
                            renderItem={({ item }) => (
                                ...
                                >
                                    <View style={tw`flex-1`}>
                                        {item?.info?.price?.regularMarketPrice
                                            ?.fmt ? (
                                            <View
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <Text
                                                        style={tw`pr-2 text-sm text-black font-normal`}
                                                    >
                                                        {item?.data?.shares}{' '}
                                                        shares
                                                    </Text>
                                                ...
                                                <View
                                                    style={tw`flex flex-col pt-2`}
                                                >
                                                    <View
                                                        style={tw`p-2 rounded-lg bg-green-600`}
                                                    >
                                                        <Text
                                ...
                                >
                                    <View style={tw`flex-1`}>
                                        {item?.info?.price?.regularMarketPrice
                                            ...
                                            >
                                                <View
                                                    style={tw`flex flex-col text-left w-24 flex-shrink`}
                                                >
                                                    <Text
                                                        style={tw`pt-2 pr-2 text-base text-black font-normal`}
                                                    >
