        ...
        <View style={tw`flex flex-col p-2 mt-3`}>
            ...
            <View>
                ...
                >
                    ...
                    <ListItem.Title style={styles}>
                        {item?.price?.summaryDetail?.previousClose?.fmt}
                    </ListItem.Title>
                </ListItem>
                <ListItem
                    bottomDivider
                ...
                >
                    ...
                    <ListItem.Title style={styles}>
                        {item?.price?.regularMarketOpen?.fmt}
                    </ListItem.Title>
                </ListItem>
                <ListItem
                    bottomDivider
                ...
                >
                    ...
                    <ListItem.Title style={styles}>
                        {item?.price?.regularMarketVolume?.fmt}
                    </ListItem.Title>
                </ListItem>
                <ListItem
                    bottomDivider
                ...
                >
                    ...
                    <ListItem.Title style={styles}>
                        {item?.summaryDetail?.dayHigh?.fmt}
                    </ListItem.Title>
                </ListItem>
                <ListItem
                    bottomDivider
                ...
                >
                    ...
                    <ListItem.Title style={styles}>
                        {item?.summaryDetail?.fiftyTwoWeekHigh?.fmt}
                    </ListItem.Title>
                </ListItem>
                <ListItem
                    bottomDivider
                ...
                >
                    ...
                    <ListItem.Title style={styles}>
                        {item?.summaryDetail?.fiftyTwoWeekLow?.fmt}
                    </ListItem.Title>
                </ListItem>
                <ListItem
                    bottomDivider
                ...
                >
                    ...
                    <ListItem.Title style={styles}>
                        {item?.summaryDetail?.fiftyDayAverage?.fmt}
                    </ListItem.Title>
                </ListItem>
                <ListItem
                    bottomDivider
